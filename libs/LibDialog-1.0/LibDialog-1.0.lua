...
function lib:Spawn(reference, data)
    ...
    if #active_dialogs > 0 then
        ...
        -- Ensure _G.StaticPopup_DisplayedFrames exists and has elements before accessing it
        local default_dialog = _G.StaticPopup_DisplayedFrames and #_G.StaticPopup_DisplayedFrames > 0 and _G.StaticPopup_DisplayedFrames[#_G.StaticPopup_DisplayedFrames]
